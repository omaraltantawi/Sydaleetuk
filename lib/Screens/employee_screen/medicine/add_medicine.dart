...
class EmployeeAddMedicine extends StatefulWidget {
  static const String routeName = 'EmployeeAddMedicine';

  @override
  _EmployeeAddMedicineState createState() => _EmployeeAddMedicineState();
}

class _EmployeeAddMedicineState extends State<EmployeeAddMedicine> with CanShowMessages {
  List<File> image = [];
  String medicineName;
  String barCode;
  String price;
