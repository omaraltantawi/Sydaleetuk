...
class Notifications {
  ...
  //-------------| function to inicialize local notifications (we can delete this if we want , not necessary) |---------------------------
  Future onSelectNotification(String wheretofindit) async {
    showDialog(
      context: _context,
      builder: (_) {
        return new AlertDialog(
          title: Text("Where to find it ?"),
          content: Text("Go To App Home page to buy new one"),
        );
      },
    );
  }
