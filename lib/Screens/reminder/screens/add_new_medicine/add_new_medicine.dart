...
import 'package:graduationproject/Screens/reminder/database/repository.dart';
import 'package:graduationproject/Screens/reminder/helpers/snack_bar.dart';
import 'package:graduationproject/Screens/reminder/models/medicine_type.dart';
import 'package:graduationproject/Screens/reminder/models/pill.dart';
import 'package:graduationproject/Screens/reminder/notifications/notifications.dart';
        ...
        builder: (BuildContext context, Widget child) {
          return Theme(
            data: ThemeData.light().copyWith(
              primaryColor: const Color(0xFF099F9D),
              accentColor: const Color(0xFF099F9D),
              colorScheme: ColorScheme.light(primary: const Color(0xFF099F9D)),
