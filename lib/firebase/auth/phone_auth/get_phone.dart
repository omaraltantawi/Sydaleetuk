...
import 'package:graduationproject/firebase/auth/phone_auth/select_country.dart';
import 'package:graduationproject/firebase/auth/phone_auth/verify.dart';
...
class PhoneAuthGetPhone extends StatefulWidget {
  ...
  PhoneAuthGetPhone({this.authData,this.userType});
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: PhoneNumberField(
              ...
              prefix: countriesProvider.selectedCountry.dialCode ?? "+962",
            ),
          ),
    ...
    bool validPhone = await phoneAuthDataProvider.instantiate(
        ...
        onCodeSent: () {
          ...
          Navigator.of(context).pushReplacement(CupertinoPageRoute(
              builder: (BuildContext context) => PhoneAuthVerify( authData: widget.authData,usertype: widget.userType,)));
        },
        onFailed: () {
